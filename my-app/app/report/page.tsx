...
import { createUser, getUserByEmail, createReport, getRecentReports } from '@/utils/Database/actions';
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto text-gray-800">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg mb-12">
        ...
        <Button type="button" className="bg-indigo-600 hover:bg-indigo-700 text-white py-3 text-lg rounded-xl transition-colors duration-300" onClick={handleVerify}>
          {verificationStatus === 'verifying' ? <Loader className="animate-spin mr-2" /> : <CheckCircle />}
          Verify Waste
        </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            <label htmlFor="amount" className="block text-sm font-medium text-black mb-1">Estimated Amount</label>
            <input
              type="text"
              id="amount"
              name="amount"
